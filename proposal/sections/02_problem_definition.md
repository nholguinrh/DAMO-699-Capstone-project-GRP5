## Problem Definition
The Canadian fixed-income market depends on the timely interpretation of monetary policy, sovereign bond yields, and exchange-rate movements. However, these indicators are published as separate time-series datasets with different frequencies, formats, and update schedules, which makes them difficult to integrate and analyze consistently. As a result, financial analysis of the yield curve is often fragmented, time-consuming, and difficult to reproduce.
